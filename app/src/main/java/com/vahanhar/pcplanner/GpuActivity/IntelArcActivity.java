...
public class IntelArcActivity extends AppCompatActivity {
        ...
        intelCollectionRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(IntelArcActivity.this, R.layout.desc_list_item, documentIds);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(IntelArcActivity.this, DescriptionActivity.class);
                            intent.putExtra("documentId", documentId);
                            intent.putExtra("collectionPath", "PC Components/GPU/INTEL");
