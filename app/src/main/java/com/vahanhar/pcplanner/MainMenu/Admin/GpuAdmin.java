...
public class GpuAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AmdRadeon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GpuAdmin.this, AmdRadeonAdmin.class));
            }
        });
        IntelArc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GpuAdmin.this, IntelArcAdmin.class));
            }
        });
        Nvidia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GpuAdmin.this, NvidiaAdmin.class));
            }
        });
    }
