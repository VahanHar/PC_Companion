...
public class Nvidia2Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nvidia2);
        ...
        modifyItemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (brand.isEmpty() || generation.isEmpty() || characteristics.isEmpty() || itemName.isEmpty() || LDate.isEmpty()
                    ...
                    CollectionReference intelCollectionRef = cpuDocRef.collection("NVIDIA");
