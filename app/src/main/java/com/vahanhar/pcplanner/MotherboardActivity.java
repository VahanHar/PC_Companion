package com.vahanhar.pcplanner;
...
public class MotherboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference cpuDocRef = parentCollectionRef.document("MOTHERBOARD");
        intelCollectionRef = cpuDocRef.collection("MOTHERBOARD");
        ...
        intelCollectionRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(MotherboardActivity.this, R.layout.desc_list_item, documentIds);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(MotherboardActivity.this, DescriptionActivity.class);
                            intent.putExtra("documentId", documentId);
                            intent.putExtra("collectionPath", "PC Components/MOTHERBOARD/MOTHERBOARD");
