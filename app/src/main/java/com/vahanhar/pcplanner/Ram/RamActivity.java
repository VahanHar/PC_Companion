package com.vahanhar.pcplanner.Ram;
...
public class RamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference cpuDocRef = parentCollectionRef.document("RAM");
        intelCollectionRef = cpuDocRef.collection("RAM");
        ...
        intelCollectionRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(RamActivity.this, R.layout.desc_list_item, documentIds);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(RamActivity.this, DescriptionActivity.class);
                            intent.putExtra("documentId", documentId);
                            intent.putExtra("collectionPath", "PC Components/RAM/RAM");
